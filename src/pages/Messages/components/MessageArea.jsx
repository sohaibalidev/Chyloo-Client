...
//               style={{ backgroundColor: getPlaceholderColor(displayInfo.name) }}
//             >
...
//             className={styles.profileAvatarPlaceholder}
//             style={{
//               backgroundColor: getPlaceholderColor(displayInfo.name),
...
//                             style={{ backgroundColor: getPlaceholderColor(message.senderId?.name) }}
//                           >
...
//                       {message.text && <div className={styles.textContent}>{message.text}</div>}
